...
>
> App version: **v2.9.10-beta** · 0 static + 109 JS-rendered controls · runtime-verified 8 screens.
...
- **`renderG()`** → `openAnnounce`, `openSubOrder`
